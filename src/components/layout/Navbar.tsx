...
export default function Navbar() {
  ...
  if (user) {
    ...
    navRows.push(
      { kind: "row", key: "cards", label: "Cards and Wallet", onClick: () => { setSliderOpen(false); router.push("/cards"); } },
        ...
        {sliderOpen && (
          <>
            ...
            <motion.aside
              ...
              className={cn(
                "fixed inset-y-0 right-0 z-[55] flex w-[620px] max-w-[94vw] flex-col border-l backdrop-blur-2xl",
                lightNav
          ...
          {BOTTOM_TABS.map((t) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={cn(
                    "absolute left-1/2 top-0 h-[2px] -translate-x-1/2 rounded-full transition-all duration-500",
