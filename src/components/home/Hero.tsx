...
/* Full-bleed hero backdrop — fashion portrait on desktop, portrait crop on mobile;
   the night overlays deepen it in dark mode, day keeps it original. */
const HERO_IMG = "https://img.magnific.com/premium-photo/glamorous-monochrome-portrait-woman-blazer_1228018-9837.jpg?semt=ais_hybrid&w=740&q=80";
